            ...
            <div className="relative p-8">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-3">
                  ...
                  {import.meta.env.DEV && (
                    <Button
                      onClick={() => DemoDataGenerator.generateSampleData(3)}
                      variant="outline"
                      className="flex items-center gap-2 bg-purple-50/50 dark:bg-purple-900/20 backdrop-blur-sm border-purple-200 dark:border-purple-600 hover:bg-purple-100 dark:hover:bg-purple-900/40 transition-all duration-200 text-purple-700 dark:text-purple-400"
                    >
              ...
              {totalCount === 0 ? (
                <div className="space-y-6">
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <Button
                      onClick={() => DemoDataGenerator.generateSampleData(5)}
                      variant="outline"
                      className="border-2 border-purple-300 hover:border-purple-400 text-purple-700 hover:text-purple-800 dark:border-purple-600 dark:text-purple-400 dark:hover:text-purple-300"
                    >
